    ...
    <div className="relative font-[poppins]">
      ...
      <nav className="sticky top-0 z-50 w-full border-b border-gray-800 bg-gray-900/80 backdrop-blur-md md:px-5">
        <div className="container flex h-16 items-center justify-between">
              ...
              <SheetContent side="right" className="border-gray-800 bg-gray-900/95 backdrop-blur-md">
                <div className="grid gap-6 py-6">
                  <div className="flex flex-col space-y-3">
                    ...
                    <NavLink href="/submissions" currentPath={pathname} mobile>
                      Submissions
                    </NavLink>
                    <NavLink href="/statistics" currentPath={pathname} mobile>
                      Statistics
                    </NavLink>
                    <NavLink href="/profile" currentPath={pathname} mobile>
                      Profile
                    </NavLink>
                  </div>
                  <div className="flex flex-col space-y-2">
          ...
          {/* Desktop Navigation Links */}
          <div className="hidden md:flex items-center space-x-14">
            <NavLink href="/contests" currentPath={pathname}>
              Contests
            </NavLink>
            <NavLink href="/submissions" currentPath={pathname}>
              Submissions
            </NavLink>
            <NavLink href="/statistics" currentPath={pathname}>
              Statistics
            </NavLink>
  ...
  return (
    <Link
      ...
      className={`
        ...
        ${isActive && !mobile ? "relative after:absolute after:bottom-[-18px] after:left-0 after:right-0 after:h-[3px] after:bg-gradient-to-r after:from-violet-600 after:to-indigo-600" : ""}
      `}
    >
      {children}
    </Link>
